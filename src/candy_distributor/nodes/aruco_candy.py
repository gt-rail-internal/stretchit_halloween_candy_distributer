...
class ArucoGraspCandy(hm.HelloNode):
  def __init__(self):
    ...
    self.wrist_extension_offset = -0.17
    self.head_pan = -1.5
    self.head_tilt = -0.5    
  ...
  def reach_candy_delivery_pose(self):
    ...
    reach_delivery = [-0.12637118506165643, 0.9158650563985633, 0.5, 0.1674595693441825, self.head_pan, self.head_tilt]
    release_grasp = [0.20268437786715443,  0.9158650563985633, 0.5, 0.1674595693441825, self.head_pan, self.head_tilt]
  ...
  def stow_for_visibility(self):
    ...
    move_up_pt = [0.9, 0.5, 0.1674595693441825]
  ...
  def camera_scan_non_blocking(self):
    camera_left_pose = [self.head_pan+0.5, self.head_tilt]
    camera_right_pose = [self.head_pan-0.5, self.head_tilt]
    trajectory_goal = FollowJointTrajectoryGoal()
    trajectory_goal.trajectory.joint_names = self.camera_joint_names
    trajectory_goal.trajectory.header.stamp = rospy.Time(0.0)
    trajectory_goal.trajectory.header.frame_id = 'base_link'
  ...
  def aruco_grasp_candy_command(self,candy_no):
    ...
    reach_pre_grasp = [0.20268437786715443, self.wrap_height(height+0.1), self.wrap_extension(wrist_extension-0.05), self.wrist_yaw_stow, self.head_pan, self.head_tilt]
    
    #lower_arm_pre_grasp = [0.20268437786715443, 0.7513784372841598, 0.3, 0.1674595693441825, -1.8338199879850292, 0.0]
    lower_arm_pre_grasp = [0.20268437786715443, self.wrap_height(height+0.1), self.wrap_extension(wrist_extension), self.wrist_straight, self.head_pan, self.head_tilt]
